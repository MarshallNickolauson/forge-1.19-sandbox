package net.marsh.tutorialmod.screen;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.PoseStack;
import net.marsh.tutorialmod.TutorialMod;
import net.marsh.tutorialmod.screen.renderer.EnergyInfoArea;
import net.marsh.tutorialmod.util.MouseUtil;
...
public class GemInfusingStationScreen extends AbstractContainerScreen<GemInfusingStationMenu> {
    ...
    public GemInfusingStationScreen(GemInfusingStationMenu stationMenu, Inventory inventory, Component component) {
